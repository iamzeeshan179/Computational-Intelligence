...
class Coordinate:
    ...
    # Hash method for Coordinate
    # return The hash of the pair of points
    def __hash__(self):
    ...
    # Get euclidean distance given self and another points
    # @return the distance
    def get_distance(self, p2):
        delta_x2 = (self.x - p2.x) ** 2
        delta_y2 = (self.y - p2.y) ** 2
